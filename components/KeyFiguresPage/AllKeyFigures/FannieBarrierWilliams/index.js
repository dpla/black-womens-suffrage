  ...
  return (
    <>
      ...
      <section>
        ...
        <p>She also became involved in the reform and women's suffrage movements, and contributed to the Hyde Park Colored Voters Republican Club. As part of her work with the Illinois Women's League, she gave lectures on the importance of suffrage for Black women. In 1891, helped found the interracial <Link href="/search?q=Provident+Hospital">Provident Hospital</Link> to create opportunities for Black doctors and nurses, as well as its associated nursing school for Black women. In order to advocate for more resources for Black women, including access to education, childcare, employment assistance and banks, Williams helped to found the <SearchTag label="National League of Colored Women" tag="blackwomensuffrage_national_league_of_colored_women"/> in 1893.Three years later, she was active in the merging of this group with others to form the <SearchTag label="National Association of Colored Women (NACW)" tag="blackwomensuffrage_national_association_of_colored_women"/>.</p>
      </section>

      <section>
        <SectionTitle title="Speeches" />
        <p>During the planning of the 1893 Columbian Exposition in Chicago, she worked to have African Americans included in the planning process and to ensure representation in the exhibits. She also gave a speech entitled "The Intellectual Progress and Present Status of the Colored Women of the United States since the Emancipation Proclamation," to the Departmental Congress of the National Association of Loyal Women of American Liberty at the <SearchTag tag="blackwomensuffrage_worlds_congress_of_representative_women" label="World's Congress of Representative Women"/>, in which she described the obstacles facing Black women searching for employment, arguing that ability and talent counted "for nothing."</p>
        <p>Several months later, she gave a speech to the <SearchTag tag="blackwomensuffrage_worlds_parliament_of_religions" label="World's Parliament of Religions"/> about racial equality within religious organizations, and the important role that organized religion could play in building a better society. With these two speeches, she gained a national reputation and became a sought after speaker.</p>
      </section>

      <section>
        <SectionTitle title="Historian of the Black Women's Club Movement" />
        <p>She was nominated for membership in the exclusive <SearchTag tag="blackwomensuffrage_chicago_womens_club" label="Chicago Women's Club"/>, setting off a long debate within the all-white club about granting membership to a Black woman and prompting several resignations when she was accepted in 1895.</p>

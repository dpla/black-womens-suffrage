    ...
    <>
      ...
      <section>
        ...
        <section className={scss.left_border_text_box__container}>
          <p>During the Civil War, Truth used her voice to help recruit Black soldiers to fight for the Union. She also worked for the <SearchTag label="National Freedman's Relief Association" tag="blackwomensuffrage_national_freedmans_relief_association"/> to solicit donations & encourage relief efforts for Black refugees.</p>
        </section>

  ...
  return (
    <>
      ...
      <section>
        ...
        <p>After graduating in 1898, racial discrimination prevented her from obtaining a teaching position in the Washington, D.C. public schools and she instead took a position working for a Baptist newspaper in Philadelphia. She went on to work for the <Link href='/search?q="National+Baptist+Convention"'>National Baptist Convention (NBC)</Link> Foreign Mission Board, and later for the NBC's corresponding secretary, eventually relocating to work for him in Louisville, Kentucky. While in Louisville, she founded a club to offer evening vocational classes, work that presaged her eventual career in education.</p>

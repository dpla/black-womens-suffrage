  ...
  return (
    <>
      ...
      <section>
        ...
        <p>She left AERA to form the <SearchTag label="American Woman Suffrage Association" tag="blackwomensuffrage_american_woman_suffrage_association"/> when AERA leaders <Link href="/search?q=susan+b+anthony">Susan B. Anthony</Link> and <Link href="/search?q=elizabeth+cady+stanton">Elizabeth Cady Stanton</Link> made racist statements about Black men and refused to support the passage of the <SearchTag label="15th Amendment" tag="blackwomensuffrage_fifteenth_amendment"/>, which granted Black men the right to vote.</p>
      </section>

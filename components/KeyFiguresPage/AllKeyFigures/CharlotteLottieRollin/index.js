  ...
  return (
    <>
      ...
      <section>
        ...
        <p>In 1869, Rollin gave a speech on the floor of the South Carolina House of Representatives in favor of universal suffrage. The next year, she was the chair and founder of the South Carolina Woman's Rights Association, and in 1871, she led a meeting at the state capitol pushing for women's suffrage. A member of the <SearchTag tag="blackwomensuffrage_national_american_women_suffrage_association" label="American Woman Suffrage Association (AWSA)"/> and the organizer of its South Carolina chapter, Rollin wrote in an 1871 article in the AWSA's Woman's Journal: "We ask suffrage not as a favor, not as a privilege, but as a right based on the grounds that we are human beings and as such entitled to all human rights." In 1872, Rollin worked alongside her sisters, as well as AWSA leader <Link href="/search?q=lucy+stone">Lucy Stone</Link>, to push for an ultimately unsuccessful constitutional amendment granting women's suffrage in South Carolina.</p>
      </section>

  ...
  return (
    <>
      ...
      <section>
        ...
        <p>In addition to her work with the Neighborhood Union, Hope helped to found the Atlanta chapter of the National Association of Colored Women (NACW), and worked with that group in support of women's suffrage, which she called the "safeguard of the nation."</p>
        <p>In 1932, Hope became the First Vice President of the Atlanta chapter of the National Association for the Advancement of Colored People (NAACP). She worked with the NAACP to create "citizenship schools," which taught classes on voting, democracy and the Constitution; these schools were then replicated in other areas of the country and helped inspire methods used by groups like Student Non-Violent Coordinating Committee (SNCC) and the Congress of Racial Equality (CORE) during the Civil Rights Movement.</p>

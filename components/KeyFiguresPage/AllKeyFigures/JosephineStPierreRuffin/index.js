  ...
  return (
    <>
      ...
      <section>
        ...
        <p>Early in their marriage, the Ruffins moved to England to protest the 1857 <Link href='/search?q="dred+scott"'>Dred Scott</Link> decision, which bolstered the system of slavery in the United States and ruled that Congress could not prohibit slavery in U.S. territories. After returning to Boston to advocate for abolition, Ruffin and her husband recruited Black soldiers for Massachusetts regiments of the Union Army during the Civil War, including the much-lauded <Link href="/search?q=Massachusetts+54th">Massachusetts 54th</Link>. In 1879, she founded the Boston Kansas Relief Association, which raised money to help African Americans who had migrated to Kansas.</p>
      </section>

      <section>
        <SectionTitle title="Suffrage" />
        <p>A committed believer in women's rights and civil rights, Ruffin was a charter member of the <SearchTag label="Massachusetts School Suffrage Association" tag="blackwomensuffrage_massachusetts_school_suffrage_association"/>, which pushed for women to be able to vote in school board elections, as well as run for school board positions. Her work with school suffrage brought her into contact with suffragists <Link href="/search?q=julia+ward+howe">Julia Ward Howe</Link> and <Link href="/search?q=lucy+stone">Lucy Stone</Link>, who invited her to join the <SearchTag label="New England Women's Club" tag="blackwomensuffrage_new_england_womens_club"/>; she was the group's first African-American member. Ruffin worked as a writer for the Black newspaper <Link href='/search?q="boston+courant"'>The Courant</Link> and was a member of the New England Women's Press Association.</p>
      </section>

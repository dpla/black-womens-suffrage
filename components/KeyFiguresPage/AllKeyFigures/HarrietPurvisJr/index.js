  ...
  return (
    <>
      ...
      <section>
        ...
        <p>The daughter of prominent abolitionists and equal rights activists <Link href="/search?q=harriet+forten+purvis">Harriet Forten Purvis</Link> and <SearchTag label="Robert Purvis" tag="blackwomensuffrage_robert_purvis"/>, Harriet Purvis, Jr., known as Hattie, grew up in a household that was at the center of the abolitionist movement in Pennsylvania, as well as a stop on the <Link href="/search?q=underground+railroad">Underground Railroad</Link>. Her parents associated with a variety of well-known social reformers including <Link href="/search?q=susan+b+anthony">Susan B. Anthony</Link> and <Link href="/search?q=lucretia+mott">Lucretia Mott</Link>. She attended the highly progressive Friends Eagleswood School, a coeducational and biracial institution in Perth Amboy, New Jersey, founded by abolitionist <Link href="/search?q=theodore+weld">Theodore Weld</Link>.</p>
      </section>

    ...
    <>
      ...
      <section>
        ...
        <section className={scss.left_border_text_box__container}>
          <p>Wells published <Link href='/search?q="a+red+record"'>A Red Record: Tabulated Statistics and Alleged Causes of Lynching in the United States, 1892-1894</Link>, in which she used data to describe how lynching was used deliberately as a tool to preserve white supremacy and limit the upward mobility of African Americans.</p>
        </section>
      ...
      <section>
        ...
        <p>She was critical of <Link href="/search?q=booker+t+washington">Booker T. Washington</Link> and what she considered to be his accommodationist approach; she was instead a supporter of <Link href="/search?q=marcus+garvey">Marcus Garvey</Link> and Timothy Thomas Fortunes. The U.S. Secret Service declared her a radical for her alliance with Garvey and his United Negro Improvement Association (UNIA). In 1909, Wells-Barnett was one of two women to help found the <SearchTag label="National Association for the Advancement of Colored People (NAACP)" tag="blackwomensuffrage_naacp"/>, although she later distanced herself from the organization, as she felt that it was not taking a strong enough stand against racism. </p>
      </section>
      ...
      <section>
        ...
        <CurvedTextBox text={<p>In 1915, Wells-Barnett and the Alpha Suffrage Club were instrumental in successfully registering and organizing Black voters to help elect <Link href="/search?q=oscar+depriest">Oscar DePriest</Link> as Chicago’s first Black alderman.</p>}/>

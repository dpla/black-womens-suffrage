  ...
  return (
    <>
      ...
      <section>
        ...
        <p>Pioneering investigative journalist, civil rights activist, suffragist and feminist Ida B. Wells-Barnett was born enslaved in Holly Springs, Mississippi, in July 1862 during the American Civil War. When the war ended and the Reconstruction era began, Wells’ parents, James and Lizzie Wells, became active in Republican politics. Her father, a skilled carpenter, was  a member of the Freedmen’s Aid Society, which founded Shaw University (now Rust College), a school for those recently freed from enslavement, in Holly Springs. James Wells was a trustee at Shaw and Wells and her siblings attended the school, as did her mother. In 1878, the death of her parents and infant brother from yellow fever forced Wells to leave school at age 16 to care for her five siblings. </p>
        <p>Despite her young age, Wells was able to get a job as a teacher at a local elementary school to support the family while her grandmother cared for the children during the day. After her grandmother died, Wells moved with two of her sisters to live with an aunt in Memphis, Tennessee, where she continued to work as a teacher, while attending Fisk University in Nashville during summer breaks. In 1884, while riding a train from Memphis to Nashville, a train conductor ordered Wells to sit in the colored section of the train despite the fact that she had purchased a first class ticket. When she refused, the train crew forcibly removed her from the train; Wells protested and defiantly bit a crew member’s hand. Wells sued the railroad, winning a $500 settlement in circuit court, although in 1887 the decision was overturned by the Tennessee Supreme Court.</p>
      </section>
      ...
      <section>
        ...
        <BorderedTextBox text={`In 1892, in what is now known as the People’s Grocery lynching, three Black men who were acquaintances of Wells’ were lynched by a white mob angry that a grocery store owned by one of the Black men was successfully competing with a white-owned store. Wells wrote articles denouncing the lynching, and, began to conduct lynching investigations, concluding that innocent Black men were being lynched on the basis of trumped up charges, usually of raping white women. Wells’ investigations found that not only were most victims of lynching innocent of any crime, but that lynching was used as a form of economic retaliation against Black men who were succeeding financially.`}/>
      ...
      <section>
        ...
        <LeftBorderTextBox text="Wells moved to New York, where she wrote for the New York Age and continued her thorough investigations of lynchings all over the South, detailing her findings in a pamphlet called “Southern Horrors: Lynch Law in All Its Phases” in 1892." />
        <p>She earned a national following with both her accessible writing style and a successful speaking tour. Wells believed that creating international pressure was the most effective way to galvanize the U.S. government to address the problem of lynching, and embarked on tours of England and Scotland, lecturing about her investigations. In 1893, Wells began calling for a  boycott of the World Columbian Exposition, to be held in Chicago later that year, in response to racism among the fair’s planners, and published and distributed a pamphlet entitled, “The Reason Why the Colored American Is Not in the Columbian Exposition.”</p>
        <CurvedTextBox text="Wells moved to Chicago, where she helped to found the Ida B. Wells Club, which started Chicago’s first Black kindergarten as well as the city’s first Black orchestra."/>
        ...
        <LeftBorderTextBox text="Wells published The Red Record: Tabulated Statistics and Alleged Causes of Lynching in the United States, 1892-1894, in which she used data to describe how lynching was used deliberately as a tool to preserve white supremacy and limit the upward mobility of African Americans."/>
      ...
      <section>
        ...
        <CurvedTextBox text="Wells-Barnett founded, along with white suffragist Belle Squire, the Alpha Suffrage Club in Chicago with the goal of both drumming up support for suffrage among Black women and providing education about citizenship and voting. It was the first organization of its kind in Chicago, and Wells-Barnett served as its first president. "/>
        ...
        <LeftBorderTextBox text={`"The southern women have tried to evade the question time and again by giving some excuse or other every time it has been brought up. If the Illinois women do not take a stand now in this great democratic parade then the colored women are lost."`}/>

  ...
  return (
    <>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p><SearchTag label="Fannie Barrier Williams" tag="blackwomensuffrage_fannie_barrier_williams"/>'s history of the Black women's club movement is published. In it, she estimates that by 1900 there were 400 Black women's clubs nationwide, with 50 to 200 members each.</p>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          ...
          <p><SearchTag label="Alpha Kappa Alpha" tag="blackwomensuffrage_alpha_kappa_alpha"/> sorority is founded at <Link href='/search?q="howard+university"'>Howard University</Link>.</p>

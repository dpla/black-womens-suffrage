    ...
    <>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>The <SearchTag label="American Woman Suffrage Association (AWSA)" tag="blackwomensuffrage_american_woman_suffrage_association"/> and <Link href='/search?q="National+Woman+Suffrage+Association"'>National Woman Suffrage Association (NWSA)</Link> merge to form the <SearchTag label="National American Woman Suffrage Association (NAWSA)" tag="blackwomensuffrage_national_american_women_suffrage_association"/>. The new organization takes a state-by-state approach and is led by <Link href="/search?q=elizabeth+cady+stanton">Elizabeth Cady Stanton</Link> and <Link href="/search?q=susan+b+anthony">Susan B. Anthony</Link>. One of the strategies the new group deploys is to sideline Black women in an effort to win the support of Southern white women (Terborg-Penn, 56). However, Black women such as <SearchTag label="Mary Church Terrell" tag="blackwomensuffrage_mary_church_terrell"/> attend NAWSA meetings and implore white suffragists to take the disenfranchisement of Black men seriously.</p>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>Journalist Carrie Langston (mother of <Link href="/search?q=langston hughes">Langston Hughes</Link>) writes in Kansas' <em>Atchison Blade</em>, highlighting the importance of Black women's participation in politics and criticizing men who attempted to maintain women's inferior position in society (Terborg-Penn, 58).</p>

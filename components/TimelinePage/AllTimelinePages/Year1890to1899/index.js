  ...
  return (
    <>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>Journalist Carrie Langston (mother of <Link href="/search?q=langston hughes"><a>Langston Hughes</a></Link>) writes in Kansas' Atchison Blade, highlighting the importance of Black women's participation in politics and criticizing men who attempted to maintain women's inferior position in society (Terborg-Penn, 58).</p>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p><SearchTag label="Adella Hunt Logan" tag="blackwomensuffrage_adella_hunt_logan"/> becomes a member of NAWSA. Logan was also active in developing support of suffrage among members of the Tuskegee Women's Club, which became an affiliate of NACW in 1896, and of which she was an active member.</p>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>The <SearchTag label="National League of Colored Women" tag="blackwomensuffrage_national_league_of_colored_women"/>, the National Federation of Afro-American Women, and more than 100 local Black women's clubs merge to form the <SearchTag label="National Association of Colored Women's Clubs (NACW)" tag="blackwomensuffrage_national_association_of_colored_women"/>, with Mary Church Terrell as the group's first president. Other NACW leadership includes Ida B. Wells Barnett, <SearchTag label="Frances E.W. Harper" tag="blackwomensuffrage_frances_ellen_watkins_harper"/>, Josephine St. Pierre Ruffin, <SearchTag label="Anna Julia Cooper" tag="blackwomensuffrage_anna_j_cooper"/>, <SearchTag label="Fanny Jackson Coppin" tag="blackwomensuffrage_fanny_jackson_coppin"/> and others. The NACW motto is "lifting as we climb."</p>

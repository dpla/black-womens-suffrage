    ...
    <>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          ...
          <p>In a letter to the editor of the New York Standard, <Link href="/search?q=elizabeth+cady+stanton">Elizabeth Cady Stanton</Link> writes, in reference to Black men winning the vote, "In fact, it is better to be the slave of an educated white man, than of a degraded, ignorant Black one." (Davis, 44)</p>
        </div>
      </div>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          ...
          <p>Both Black men and women participate in the founding of the interracial Philadelphia Suffrage Association. <Link href="/search?q=harriet+forten+purvis">Harriet Purvis</Link> serves on the group's executive committee.</p>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          ...
          <p><Link href="/search?q=william+whipper">William J. Whipper</Link>, husband of Charlotte Rollin, argues for suffrage for women and Black men while serving as a delegate to the 1868 South Carolina Constitutional Convention.</p>
        </div>
      </div>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>AERA dissolves after infighting over support for the <SearchTag label="15th Amendment" tag="blackwomensuffrage_fifteenth_amendment"/>, which would give African-American men the right to vote, but ignore women's suffrage. In the wake of AERA's demise, the movement splits: One group of white suffragists, including Elizabeth Cady Stanton and <Link href="/search?q=susan+b+anthony">Susan B. Anthony</Link>, found the <Link href='/search?q="National+Woman+Suffrage+Association"'>National Woman Suffrage Association (NWSA)</Link>. During this period, Stanton in particular expresses racist views, doubting the ability of Black men to be responsible voters. The resulting NWSA strategy "pitted Black men against women in a racist way." (Terborg-Penn, 27). Meanwhile, Lucy Stone, <Link href="/search?q=henry+browne+blackwell">Henry Blackwell</Link> and <Link href="/search?q=julia+ward+howe">Julia Ward Howe</Link> form the <SearchTag label="American Woman Suffrage Association (AWSA)" tag="blackwomensuffrage_american_woman_suffrage_association"/>. The two groups move forward with different strategies: NWSA pursues a federal women's suffrage amendment, while AWSA takes a state-by-state approach. Black women join and are active in both groups, although more Black women choose the AWSA due to its support for suffrage for Black men, an important issue for Black women. Frances E.W. Harper, Charlotte Forten, <SearchTag label="Josephine St. Pierre Ruffin" tag="blackwomensuffrage_josephine_st_pierre_ruffin"/> and Sojourner Truth are among those that join the AWSA, while Mary Ann Shadd Cary, Harriet Purvis and Hattie Purvis are among those that join the NWSA.</p>

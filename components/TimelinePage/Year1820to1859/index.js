  ...
  return (
    <>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>First National Women’s Rights convention held in Worcester, MA. Sojourner Truth and other prominent abolitionists are in attendance.</p>
        </div>
      </div>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>Uncle Tom’s Cabin by Harriet Beecher Stowe is published.</p>
        </div>
      </div>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>Harriet Forten Purvis and Margaretta Forten play key roles in organizing the Fifth National Woman’s Rights Convention in Philadelphia.</p>
          <p>Frances Harper becomes a lecturer for the Maine Anti-Slavery Society. Over the course of the next six years, she travels extensively in the East and Midwest, lecturing about abolition. She earns a national reputation for her oratory and writing. (Gordon, Collier Thomas, p 45)</p>
        </div>
      </div>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>Mary Ann Shadd Cary edits The Provincial Freeman. She is the first Black woman newspaper editor in North America. In 1854 and 1855, she gives a series of lectures across the U.S. and Canada, advocating for abolition and women’s rights.</p>
        </div>
      </div>
      ...
      <div className={scss.timeline__tile}>
        ...
        <div className={scss.tile__p}>
          <p>Sarah Remond and her brother Charles speak at the National Woman’s Rights Convention in New York City.</p>
        </div>
      </div>
